INSERT INTO projects (name, url, thumbnailUrl, descr, author, twitter, facebook, github, date_added)
VALUES ('Code for Kids', 'http://code4kids.herokuapp.com', 'http://www.ok.gov/kids/images/code_kids.jpg',
...
VALUES ( 
        'Short Stories', 
        'http://storyshort.heroku.com',
        'http://storyshort.herokuapp.com/images/edit_4x3.jpg',
        'Share Photo Rich Short Stories on Smartphones. You already have a short story to share with your friends or family. A few beautiful photos taken while on a trip, or at an awesome dining. Your story texts deserve rich styling.',
        'Simon Kim', 'kaoma', 'kaoma.net', 'simonkim/bitstarter', NOW());
